#!/usr/bin/env python3
"""
Deployment Pipeline for Fraud Detection Model.
...
class DeploymentPipeline:
    ...
    def __init__(self, config):
        ...
        self.docker_image_name = f"{config['docker_registry']}/{self.project_name}"
...
docker pull {self.docker_image_name}:{self.docker_tag} || true
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Deploy Fraud Detection Model to Digital Ocean")
